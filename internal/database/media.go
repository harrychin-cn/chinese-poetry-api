...
type ImageGenerationJob struct {
	...
	Quality      string    `gorm:"column:quality" json:"quality,omitempty"`
	OutputFormat string    `gorm:"column:output_format" json:"output_format,omitempty"`
	Cached       bool      `gorm:"column:cached;not null;default:false" json:"cached"`
	CostUnits    int       `gorm:"column:cost_units;not null;default:0" json:"cost_units"`
...
func (r *Repository) CompleteImageGenerationJob(jobID int64, mediaAssetID *int64) (*ImageGenerationJob, error) {
	return r.CompleteImageGenerationJobWithCost(jobID, mediaAssetID, -1)
}

func (r *Repository) CompleteImageGenerationJobWithCost(jobID int64, mediaAssetID *int64, costUnits int) (*ImageGenerationJob, error) {
	if jobID < 1 {
