...
var commercialRouteContracts = []routeContract{
	...
	{http.MethodPost, "/api/v1/wallet/top-up"},
	...
	{http.MethodGet, "/api/v1/public/works"},
	{http.MethodGet, "/api/v1/public/works/:code"},
	{http.MethodGet, "/api/v1/public/works/:code/certificate"},
	{http.MethodGet, "/api/v1/public/rankings/works"},
	{http.MethodGet, "/api/v1/public/rankings/authors"},
	{http.MethodGet, "/api/v1/partners/works/export"},
	{http.MethodPost, "/api/v1/works"},
	{http.MethodGet, "/api/v1/works"},
	{http.MethodPost, "/api/v1/works/reverse-create"},
	{http.MethodGet, "/api/v1/works/reverse-jobs"},
	...
	{http.MethodGet, "/api/v1/works/:id/audio-jobs"},
	{http.MethodGet, "/api/v1/works/:id/music-jobs"},
	{http.MethodPost, "/api/v1/works/:id/images/generate"},
	{http.MethodPost, "/api/v1/works/:id/audio/generate"},
	{http.MethodPost, "/api/v1/works/:id/music/generate"},
	{http.MethodPost, "/api/v1/works/:id/tip"},
	{http.MethodGet, "/api/v1/works/:id/tips"},
	{http.MethodGet, "/api/v1/works/:id/certificate"},
	{http.MethodPost, "/api/v1/works/:id/certificate"},
	{http.MethodPost, "/api/v1/works/:id/certificate/anchor"},
	...
	{http.MethodGet, "/api/v1/admin/plagiarism/review-queue"},
	{http.MethodPost, "/api/v1/admin/plagiarism/review-queue/:id/approve"},
	{http.MethodPost, "/api/v1/admin/plagiarism/review-queue/:id/reject"},
	{http.MethodGet, "/api/v1/admin/plagiarism/corpus-sources"},
	{http.MethodPost, "/api/v1/admin/plagiarism/corpus-sources"},
